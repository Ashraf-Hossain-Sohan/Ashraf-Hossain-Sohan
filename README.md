...
* 🌐 **Frontend:** Rocking with `React`, `Vue`, `Angular`, `TailwindCSS`, `HTML5`, `CSS3`, `JavaScript/TypeScript`. Creating interfaces users *love* to interact with.
* 🛠️ **Backend:** Building robust systems using `Node.js/Express`, `Python/Django/Flask`, `Java/Spring`, `Ruby/Rails`. Making sure everything runs smoothly behind the scenes.
* 🛢️ **Databases:** Wrangling data with `PostgreSQL`, `MySQL`, `MongoDB`, `Redis`. Both relational and NoSQL are my playgrounds.
* ☁️ **DevOps & Tools:** Fluent in `Git`, `Docker`, `Kubernetes`, `AWS`, `Azure`, `GCP`, `CI/CD pipelines`. Automating and deploying like a pro.
...
My toolbox is always expanding! Here are some of the technologies I wield:
...
<details>
 <summary>Click to see some of my work!</summary>
  ...
  <a href="https://github.com/[Your GitHub Username]/[Repo Name 2]">
    <img align="center" src="https://github-readme-stats.vercel.app/api/pin/?username=[Your GitHub Username]&repo=[Repo Name 2]&theme=tokyonight" />
  </a>
  </details>
...
<p align="center">
  ...
  <a href="mailto:ashrafhossainsohan@gmail.com" target="_blank"><img src="https://img.shields.io/badge/-Gmail-%23EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Gmail"></a>
